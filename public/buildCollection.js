...
class ImageStack extends React.Component {
	...
	// Point D
	addPhotoAJAX (photoObjs[photoIndex], this.replyFromServer)
...
function addPhotoAJAX (photoObj, callback) {
    	var oReq = new XMLHttpRequest();
	var url = "query?src="+photoObj.src;
	url = url+"&tags="+keyWordStr;  // comes from global
	oReq.open("GET", url);
